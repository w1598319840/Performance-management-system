			...
			while ((s = br.readLine()) != null) {// 使用readLine方法，一次读一行
				...
				if (result[0].equals(id)) {
					...
					if (flag == 1) {
						...
						majorLabel = new JLabel("专业:" + t.getMajor());
					}else if(flag == 2) {
						ad = new Administrator(id, pwd, name, gender, birthday, institute, major);
						idLabel = new JLabel("账号:" + ad.getId());
						nameLabel = new JLabel("姓名:" + ad.getName());
						genderLabel = new JLabel("性别:" + ad.getSex());
						birLabel = new JLabel("生日:" + ad.getBirthday());
						insLabel = new JLabel("学院:" + ad.getInstitute());
						majorLabel = new JLabel("专业:" + ad.getMajor());
					}
