...
public class AdministratorPanel extends JFrame implements ActionListener {
	 ...
	 * 管理员登陆后操作主界面
	 */
	JButton deleteUser, addUser, selfInfo, infoButton;
	JPanel contain;
	String idd;
	...
	public AdministratorPanel(String idd) {
		...
		infoButton.setBounds(70, 45, 140, 30);
		selfInfo.setBounds(70, 100, 140, 30);
		addUser.setBounds(70, 155, 140, 30);
		deleteUser.setBounds(70, 210, 140, 30);
