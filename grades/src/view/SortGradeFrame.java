		...
		if (e.getSource() == submit) {
			if ((idt.getText().equals("")) || (passt.getText().equals("")) || (goodt.getText().equals(""))
				...
				if (gradeSort.hasCourse() == 0) {
					...
					if (this.result[0] == -1 && this.result[1] == -1 && this.result[2] == -1 && this.result[3] == -1) {
						JOptionPane.showMessageDialog(null, "该课程中无学生，无学生成绩信息!", "提示", JOptionPane.INFORMATION_MESSAGE);
					}else {
						showResult();	
					}
				}
